...
// Instancia única del repositorio para todos los casos de uso
const customerRepository = new CustomerRepositoryPrisma();
...
export const updateCustomer = async (req, res) => {
  try {
    ...
    // Validamos si el repositorio devolvió algo (si el ID existía)
    if (!updatedCustomer) {
...
export const deleteCustomer = async (req, res) => {
  try {
    ...
    // Validamos si se eliminó algo efectivamente
    if (!deletedCustomer) {

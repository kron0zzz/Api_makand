...
router.post("/", authorize('Crear Detalle de Orden'), createOrder_detail);
router.get("/", authorize('Listar Detalle de Orden'), getOrder_details);
router.get("/table", authorize('Listar Detalle de Orden en Tabla'), getOrder_detailsTable);
router.get("/:id", authorize('Ver Detalle de Orden'), getOrder_detailById);
router.put("/:id", authorize('Editar Detalle de Orden'), updateOrder_detail);
router.delete("/:id", authorize('Eliminar Detalle de Orden'), deleteOrder_detail);
